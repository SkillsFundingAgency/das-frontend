...
function clickFunction(element, clickFunction) {

  var elementArray = document.getElementsByClassName(element);

  for (var i = 0; i < elementArray.length; i++) {
    elementArray[i].addEventListener('click', myFunction, false);
