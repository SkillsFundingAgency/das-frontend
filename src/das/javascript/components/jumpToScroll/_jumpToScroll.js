function JumpToScroll(ele) {
    ...
    function scrollFnt(bp) {
        if (document.body.scrollTop > bp || document.documentElement.scrollTop > bp) {
            ele.classList.add('das-jump-to-scroll--show');
        } else {
            ele.classList.remove('das-jump-to-scroll--show');
        }
    }
